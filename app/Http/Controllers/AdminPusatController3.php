...
class AdminPusatController3 extends Controller
{
    /**
    ...
    public function indexPusat()
    {
        ...
        // dd($count);
        return view('adminPusat.main', compact('count'));
    }
    public function index()
    {
         //fungsi eloquent menampilkan data menggunakan paginaon
         $gudang = Gudang::where('user_id',12)->orderBy('id', 'asc')->paginate(5);
         return view('adminPusat.indexPusat3', compact('gudang'));
    }
    ...
    {
        return view('adminPusat.create3');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('adminPusat3.index')
    ...
    public function edit($id)
    {
        ...
        return view('adminPusat.edit3', compact('gudang'));
    }
    ...
    public function cari(Request $request)
    {
        ...
        $gudang = Gudang::where('user_id', 12)->where(function ($query) use ($keyword) {
