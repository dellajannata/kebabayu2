...
class GudangController3 extends Controller
{
    /**
    ...
    public function index()
    {
         ...
         return view('adminGudang.indexGudang3', compact('gudang'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('adminGudang.edit3', compact('gudang'));
    }
    ...
    public function statusSelesai($id){
        $update = Gudang::where('user_id', 12)->find($id);
        $update->update([
            'status'=> 'selesai'
        ]);
