...
class PemasukkanAdminController extends Controller
{
    ...
    {
        $pesanan = Pesanan::where('user_id',2)->orderBy('tanggal', 'desc')->paginate(5);
        return view('adminPusat.pesanindex', compact('pesanan'));
    }
    public function create()
    {
        return view('adminPusat.pesancreate');
    }
    public function store(Request $request)
    {
        ...
        return redirect()->route('adminPusatPesan.index')
    ...
    public function show($id)
    {
        ...
        return view('adminPusat.pesandetail', compact('pesanan', 'pesanan_details'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('adminPusat.pesanedit', compact('pesanan'));
    }
    ...
    public function cari(Request $request)
    {
        ...
        $pesanan = Pesanan::where('user_id', 2)->where(function ($query) use ($keyword) {
