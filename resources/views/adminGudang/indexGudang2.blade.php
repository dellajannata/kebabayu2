    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-center mt-2">
                ...
                <h4 class="col-12 text-center" style="font-family: Georgia, serif;">Cabang 2</h4>
            </div>
            <br><br>
            <div>
                ...
                <table class="table table-striped table-hover">
                    ...
                    @foreach ($gudang as $g)
                        <tr>
                            ...
                            <td>
                                <form action="/admin2/{{ $g->id }}/edit" method="POST">
                                    @method('PUT')
                                    @csrf
                                    <button type="submit" class="btn btn-primary">KIRIM</button>
                                </form>

                                <form action="/admin2/{{ $g->id }}/update" method="POST">
                                    @method('PUT')
                                    @csrf
