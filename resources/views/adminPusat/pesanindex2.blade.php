    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pull-center mt-2">
                ...
                <h4 class="col-12 text-center" style="font-family: Georgia, serif;font-size:20px">Cabang 2</h4>
            </div>
            <br><br>
            ...
            @endif
            <form class="form" method="get" action="{{ route('caripesanpusat2') }}">
                ...
                <table class="table table-striped table-hover">
                    ...
                    @foreach ($pesanan as $p)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('adminPusatPesan22.destroy', $p->id) }}" method="POST"> <a>
                                    <a class="btn btn-primary"
                                        href="{{ route('adminPusatPesan22.show', $p->id) }}">Details</a>
                                    @csrf
