...
@section('content')
    <div class="row">
        <div class="col-lg-12 margin-tb">
            ...
            @endif
            <form class="form" method="get" action="{{ route('caripesanpusat3') }}">
                ...
                <table class="table table-striped table-hover">
                    ...
                    @foreach ($pesanan as $p)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('adminPusatPesan33.destroy', $p->id) }}" method="POST"> <a>
                                        <a class="btn btn-primary"
                                            href="{{ route('adminPusatPesan33.show', $p->id) }}">Details</a>
                                        @csrf
